            ...
            <form action="{{ route('post.store') }}" method="POST" class="needs-validation" novalidate
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="postTitle"
                        ...
                        placeholder="Enter post title" value="{{ old('postTitle') }}" required>
                    @error('postTitle')
                ...
                <div class="mb-3">
                    ...
                    <textarea name="postContent" class="form-control @error('postContent') is-invalid @enderror"
                        id="postContent" rows="8" required>{{ old('postContent') }}</textarea>
                    @error('postContent')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-6">
                        ...
                        <select name="postStatus" class="form-select @error('postStatus') is-invalid @enderror"
                            ...
                            <option value="Scheduled" {{ old('postStatus') == 'Scheduled' ? 'selected' : '' }}>Scheduled
                            </option>
                        </select>
                        @error('postStatus')
                            <div class="invalid-feedback">
